...
print('net_overfitting: \n', net_overfitting)  # net architecture
print('net_dropped:\n', net_dropped)
...
for t in range(500):
    ...
    if t % 10 == 0:
        net_overfitting.eval()  # set eval mode to fix drop out effect, eval的意思是evaluation，即测试模式，不使用dropout
        net_dropped.eval()
        # plotting  测试模式下画图
        plt.cla()
        ...
        net_overfitting.train()  # set train mode  恢复到训练模式
        net_dropped.train()
